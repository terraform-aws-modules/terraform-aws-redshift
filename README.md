...
| <a name="input_cluster_security_groups"></a> [cluster\_security\_groups](#input\_cluster\_security\_groups) | A list of security groups to be associated with the cluster | `list(string)` | `null` | no |
